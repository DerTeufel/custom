LOCAL_DIR = custom/$(CUSTOM_NAME)/res/logo
BOOT_LOGO_DIR := $(LOCAL_DIR)
CUSTOM_SRC_DIR ?= $(LOCAL_DIR)/../../out
BOOT_LOGO_OUT_DIR := $(CUSTOM_SRC_DIR)
...
BMP_TO_RAW := $(BOOT_LOGO_DIR)/../../../common/tool/bmp_to_raw
ZPIPE := $(BOOT_LOGO_DIR)/../../../common/tool/zpipe
MKIMG := vendor/mediatek/proprietary/bootable/bootloader/lk/scripts/mkimage
endif
...
BOOT_LOGO_RESOURCE := $(BOOT_LOGO_DIR)/$(BOOT_LOGO).raw
LOGO_IMAGE := $(LOCAL_DIR)/logo.bin
TARGET_LOGO_IMAGE := $(PRODUCT_OUT)/logo.bin
CUSTOM_ALL_RELATE_FILES += $(LOGO_IMAGE) $(TARGET_LOGO_IMAGE)
RESOURCE_OBJ_LIST :=   \
...
$(LOGO_IMAGE):$(MKIMG) $(BOOT_LOGO_RESOURCE)
	...
	@echo "=========bll  111   $(MKIMG)"
	@echo "==========bll   2222  $(BOOT_LOGO_RESOURCE)"
	@echo "========bll 3333  $(LOGO_IMAGE)"
