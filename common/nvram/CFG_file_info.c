...
FileName aBackupToBinRegion[]=
{
    ...
    {"Factory_header", AP_CFG_CUSTOM_FILE_FACTORY_HEADER_LID},
    {"Factory_test_result", AP_CFG_CUSTOM_FILE_FACTORY_TEST_RESULT_LID},
};
...
pfConvertFunc aNvRamConvertFuncTable[]=
{
  ...
  NULL,//AP_CFG_CUSTOM_FILE_FACTORY_HEADER_LID
  NULL,//AP_CFG_CUSTOM_FILE_FACTORY_TEST_RESULT_LID
};
